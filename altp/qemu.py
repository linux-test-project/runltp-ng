    ...
    async def stop(self, iobuffer: IOBuffer = None) -> None:
        ...
        try:
            ...
            if self._cmd_lock.locked() or self._fetch_lock.locked():
                ...
                await asyncio.wait_for(self._comm_lock.acquire(), 10)
                await asyncio.wait_for(self._cmd_lock.acquire(), 10)
                await asyncio.wait_for(self._fetch_lock.acquire(), 10)
